...
from IMDBTrainingDataset import IMDBTrainingDataset
...
if __name__ == '__main__':
    training_data = IMDBTrainingDataset(train_file='vectors_train.csv')
    test_data = IMDBTrainingDataset(train_file='vectors_test.csv')
